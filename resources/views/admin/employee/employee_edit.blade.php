        ...
        <div class="content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="row" method="POST" action="/employee_manange/update">
                                @csrf
                                <div class="col-xl-12">
                                    ...
                                    <input type="hidden" name="h_id" id="h_id" value="{{ $employee->id }}">
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="last_name" class="form-control"
                                                    placeholder="Enter last name" required value="{{ $employee->last_name }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <textarea name="address" class="form-control" id="project-overview" rows="5"
                                            placeholder="Enter some brief about project.." value="{{ $employee->address }}" required></textarea>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control select2" name="gender" data-toggle="select2"
                                                    required value="{{ $employee->gender }}">
                                    ...
                                    <div class="mb-3 position-relative" id="datepicker1">
                                        ...
                                        <input type="text" class="form-control" name="id_passport_number" required value="{{ $employee->id_passport_number }}">
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="phone_number" class="form-control"
                                                    placeholder="Mobile Number" required value="{{ $employee->phone_number }}">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="email" name="email_adderss" class="form-control"
                                                    placeholder="Email" required value="{{ $employee->email_adderss }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3 position-relative" id="datepicker1">
                                        ...
                                        <input type="date" required class="form-control" name="start_date"
                                            ...
                                            data-date-format="d-M-yyyy" data-date-autoclose="true" value="{{ $employee->start_date }}">
                                    </div>
                                    <div class="mb-0">
