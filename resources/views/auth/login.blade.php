    ...
    <div class="auth-fluid">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="password" name="password" required
                                autocomplete="current-password"" id=" password" placeholder="Enter your password">
                        </div>
                        <div class="mb-3">
        ...
        <div class="auth-fluid-right text-center">
            <div class="auth-user-testimonial">
                <h2 class="mb-3">Rohim PayRoll</h2>
                <p class="lead"><i class="mdi mdi-format-quote-open"></i> It's a elegent PayRoll
                    . <i class="mdi mdi-format-quote-close"></i>
                </p>
                <p>
                    - Rohim Systems International
                </p>
